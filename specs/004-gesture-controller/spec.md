...
**Feature Branch**: `[005-gesture-controller]`  
**Created**: 2026-04-30  
**Status**: Draft  
**Input**: User description: "task \"2.1 GestureController\" trong _docs/plans/phase-2-gesture-controls.md"
...
1. **Given** video đang phát và người dùng bắt đầu vuốt dọc ở nửa phải vùng phát, **When** thao tác hoàn tất, **Then** hệ thống diễn giải thao tác đó thành yêu cầu điều chỉnh âm lượng thay vì độ sáng hoặc tua nội dung.
2. **Given** video đang phát và người dùng bắt đầu vuốt dọc ở nửa trái vùng phát, **When** thao tác hoàn tất, **Then** hệ thống diễn giải thao tác đó thành yêu cầu điều chỉnh độ sáng thay vì âm lượng hoặc tua nội dung.
3. **Given** video đang phát và người dùng vuốt ngang trên vùng phát, **When** thao tác hoàn tất, **Then** hệ thống diễn giải thao tác đó thành yêu cầu tua tiến hoặc tua lùi theo hướng vuốt.
...
3. **Given** video đang phát bình thường, **When** người dùng nhấn giữ trên vùng phát và sau đó thả tay, **Then** hệ thống kích hoạt chế độ tua nhanh tạm thời trong lúc giữ và kết thúc chế độ này ngay khi thao tác kết thúc.
...
1. **Given** người dùng đặt hai ngón tay trên vùng phát, **When** thực hiện thao tác pinch in hoặc pinch out, **Then** hệ thống diễn giải thao tác đó thành yêu cầu thay đổi mức thu phóng của video.
...
- **FR-002**: Hệ thống MUST phân loại thao tác vuốt dọc bắt đầu ở nửa phải vùng phát thành yêu cầu điều chỉnh âm lượng.
- **FR-003**: Hệ thống MUST phân loại thao tác vuốt dọc bắt đầu ở nửa trái vùng phát thành yêu cầu điều chỉnh độ sáng.
- **FR-004**: Hệ thống MUST phân loại thao tác vuốt ngang trên vùng phát thành yêu cầu tua tiến hoặc tua lùi theo hướng thao tác.
...
- **FR-007**: Hệ thống MUST kích hoạt chế độ tua nhanh tạm thời trong suốt thời gian người dùng nhấn giữ và MUST kết thúc chế độ này ngay khi thao tác giữ chấm dứt.
- **FR-008**: Hệ thống MUST diễn giải thao tác pinch thành yêu cầu thay đổi mức thu phóng video trong giới hạn thu phóng được hỗ trợ bởi màn hình phát.
...
- **SC-001**: Trong bộ kiểm thử chấp nhận bao phủ toàn bộ mapping đã đặc tả, 100% thao tác vuốt dọc, vuốt ngang, double tap, nhấn giữ và pinch được phân loại đúng theo vùng và loại cử chỉ mong đợi.
- **SC-002**: Trong 100% kịch bản double tap trái, giữa và phải, hệ thống chỉ phát ra đúng một hành động điều khiển tương ứng và không phát sinh thêm hành động phụ ngoài mong đợi.
- **SC-003**: Trong 100% kịch bản nhấn giữ hợp lệ, trạng thái tua nhanh tạm thời được kết thúc không muộn hơn 0,5 giây sau khi người dùng thả tay.
- **SC-004**: Trong bộ kiểm thử xung đột cử chỉ gồm chuyển vùng giữa chừng, đổi từ một ngón sang hai ngón và thao tác không đủ ngưỡng, 100% trường hợp không tạo ra hai kết quả điều khiển mâu thuẫn từ cùng một chuỗi chạm.
- **SC-005**: Người dùng thử nghiệm có thể hoàn thành ba thao tác cơ bản gồm chỉnh âm lượng, tua 10 giây và phóng to video trực tiếp trên vùng phát trong vòng 5 giây cho mỗi thao tác ở ít nhất 90% lượt thử đầu tiên.
...
- Tốc độ tua nhanh tạm thời mặc định là mức tua nhanh duy nhất được hỗ trợ ở giai đoạn này; các lựa chọn tốc độ phát cố định thuộc phạm vi riêng của speed selector.
